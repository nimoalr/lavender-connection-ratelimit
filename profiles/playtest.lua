-- Playtest profile. Copy this file over config.lua to activate it.
-- Paces admissions 10 seconds apart without letting queue waits stack:
-- loading players never block releases and reconnect cooldowns stay short.
